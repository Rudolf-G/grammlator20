...
namespace grammlator {
   internal sealed partial class P5GenerateCode {
      ...
      //private static void GenerateOneConditionalAction(ConditionalAction a, BitArray relevantSymbols)
      //{
      //   GlobalVariables.Codegen.IndentExactly();
      //   GlobalVariables.Codegen.AppendWithOptionalLinebreak("if (");

      //   GlobalVariables.Codegen.IncrementIndentationLevel();
      ...
      //   GlobalVariables.Codegen.DecrementIndentationLevel();
      //}
      ...
      //private static void GenerateCondition(BitArray Condition, BitArray Relevant)
      //{
      ...
      //      )
      //   {
      //      GenerateIsIn(Condition, Relevant);
      ...
      //private static void GenerateIsIn(BitArray Condition, BitArray Relevant)
      //{
      //   GlobalVariables.Codegen.IncrementIndentationLevel();
      ...
      //   else
      //   {
      //      GlobalVariables.Codegen.Append('!')
      //         .Append(GlobalVariables.IsInMethod.Value)
      //         .Append('(');
      //      GenerateIsInArguments(InverseCondition);
      //   }
      //   GlobalVariables.Codegen.DecrementIndentationLevel().Append(')');
      //}
