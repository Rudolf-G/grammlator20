...
namespace Grammlator {
   ...
   internal sealed partial class P1aParser: GrammlatorApplication {
      ...
      private void OneMoreExcludedTerminalSymbol(Int32 stringIndex)
         {
      ...
      private void EnumElementRecognized(Int32 enumElementStringIndex)
          => (Enumlist ?? (Enumlist
         = new List<String>(50))).Add(GlobalVariables.GetStringOfIndex(enumElementStringIndex));
...
#pragma warning disable IDE0059 // Der Wert, der dem Symbol zugeordnet ist, wird niemals verwendet.
         ...
         #region grammlator generated Sun, 12 Apr 2020 15:58:37 GMT by Grammlator version 0:21 (build Sun, 12 Apr 2020 07:40:56 GMT)
      ...
      State79:
         ...
         const String StateDescription79 =
              "GrammarRule(Symbol SymbolAtLeftSide, Int32 NumberOfAttributes)= outerLeftSide(Symbol SymbolAtLeftSide, Int32 NumberOfAttributes), \"-=\", ListOfExcludedTerminalSymbols, ►\";\";\r\n"
            + "ListOfExcludedTerminalSymbols= ListOfExcludedTerminalSymbols, ►\"|\", Name(Int32 stringIndex);";
         ParserInput = Lexer.PeekSymbol();
         if (ParserInput == LexerResult.DefinitionSeparatorSymbol)
            {
            Lexer.AcceptSymbol();
      ...
      State80:
          ...
          * ListOfExcludedTerminalSymbols= ListOfExcludedTerminalSymbols, "|", Name(Int32 stringIndex);◄ method: OneMoreExcludedTerminalSymbol, aStack: -1
          */
      ...
      EndOfGeneratedCode1:
         ;
         #endregion grammlator generated Sun, 12 Apr 2020 15:58:37 GMT by Grammlator version 0:21 (build Sun, 12 Apr 2020 07:40:56 GMT)
         /* ************************ code written by programmer ******************** */
