   ...
   internal sealed partial class P1aParser : GrammlatorApplication {
      ...
      private void CompareTerminalDeclarationsWithEnum()
      {
         if (EnumNames.Count == 0)
            return; // nothing to add or to compare
      ...
      private void AddMissingTerminalsFromEnum()
      {
         ...
         Int32 explcitelyDefinedTerminalsCount = SymbolDictionary.Count;
         ...
         if (addedTerminalsCount>0 && explcitelyDefinedTerminalsCount>0)
