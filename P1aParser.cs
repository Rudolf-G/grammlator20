...
namespace Grammlator {
   ...
   internal sealed partial class P1aParser: GrammlatorApplication {
      ...
      private void CSintMethodRecognized(out IntMethodClass? intMethod, MethodClass method)
         {
         if (!(method is IntMethodClass))
            {
            P1OutputMessageAndLexerPosition(MessageTypeOrDestinationEnum.Error, $"Expected {typeof(IntMethodClass)} method, got {method.GetType()}");
            intMethod = null;
            }
         else
...
#pragma warning disable IDE0059 // Der Wert, der dem Symbol zugeordnet ist, wird niemals verwendet.
         ...
         #region grammlator generated Sun, 03 May 2020 11:40:03 GMT (grammlator, File version 2020.04.07.1 03.05.2020 11:39:50)
      ...
      State85:
         ...
         Debug.Assert(ParserInput == LexerResult.GroupEnd);
         Lexer.AcceptSymbol();
         /* Reduction 85, sStack: -1, aStack: 1
      ...
      EndOfGeneratedCode:
         ;
         #endregion grammlator generated Sun, 03 May 2020 11:40:03 GMT (grammlator, File version 2020.04.07.1 03.05.2020 11:39:50)
         /* ************************ code written by programmer ******************** */
