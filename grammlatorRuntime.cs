...
namespace GrammlatorRuntime {
   ...
   /// </param>
   public abstract class GrammlatorInput<TTypeOfOutputSymbols>(StackOfMultiTypeElements attributeStack)
...
#pragma warning restore IDE1006 // Benennungsstile
   ...
   /// </param>
   public abstract class GrammlatorApplication(Int32 initialSizeOfAttributeStack = 10, Int32 initialSizeOfStateStack = 10)
   {
...
#pragma warning restore CA1707 // Bezeichner dürfen keine Unterstriche enthalten
         get; protected set;
      } = new StackOfMultiTypeElements(initialSizeOfAttributeStack);
...
#pragma warning restore CA1707 // Bezeichner dürfen keine Unterstriche enthalten
         get;
      } = new Stack<Int32>(initialSizeOfStateStack);
...
#pragma warning restore IDE1006 // Benennungsstile
   ...
   /// </param>
   public abstract class GrammlatorInputApplication<TTypeOfOutputSymbols>(StackOfMultiTypeElements attributeStack, Stack<Int32> stateStack)
       : GrammlatorInput<TTypeOfOutputSymbols>(attributeStack) where TTypeOfOutputSymbols : IComparable  /* enum */
       {
      /// <summary>
